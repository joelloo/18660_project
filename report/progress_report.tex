...
iFrALM is based on an incremental SVD (iSVD) algorithm. iSVD is a method to update the matrix's SVD with newly-added part based on the original matrix's SVD, to update the matrix's SVD with newly-added columns. iFrALM implements the iSVD method presented by Zha [7].
